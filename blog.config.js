...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '大有可惟', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '境随心转 心想事成', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://jamie。nalenti.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '每日摘抄, 博客, 成长笔记', // 网站关键词 英文逗号隔开
